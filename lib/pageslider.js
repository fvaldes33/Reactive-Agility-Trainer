...
function PageSlider(container) {
    ...
    this.slidePageFrom = function(page, from) {
        ...
        if (!currentPage || !from) {
            page.attr("class", "off-canvas-wrap page center");
            currentPage = page;
            return;
        }
        ...
        page.attr("class", "off-canvas-wrap page transition center");
        currentPage.attr("class", "off-canvas-wrap page transition " + (from === "left" ? "right" : "left"));
        currentPage = page;
